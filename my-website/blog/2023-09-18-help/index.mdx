...
tags: [kdb/q, Help, StackOverFlow, KX Community, Mentorship, KDB Beginner, KDB Learning]
---
...
**KX** has recently launched a **public Slack workspace** for the KDB/Q community, a great place to ask questions, connect with fellow KDB/Q enthusiasts, discover job opportunities in the `#careers` channel, and stay up to date about the latest developments across the ecosystem.
If you're working with KDB/Q or just curious to learn more, make sure to join the conversation [here](https://kx-community.slack.com/join/shared_invite/zt-2xdd6ln75-1MyNtCPm3t6ZmCpD5Fnbkw#/shared-invite/email)!
